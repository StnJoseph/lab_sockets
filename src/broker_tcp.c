    ...
    typedef struct {
        SOCKET sock;
        int    active;
        char   topics[MAX_SUBS][MAX_TOPIC];  /* suscripciones */
        int    nsubs;
    ...
    int main(int argc, char** argv){
        ...
        for (;;){
            ...
            /* En Winsock, el 1er argumento de select() se ignora → usa 0 */
            ...
            for (int i=0;i<MAX_CLIENTS;++i){
                ...
                /* Compactar buffer (dejar remanente no terminado) */
